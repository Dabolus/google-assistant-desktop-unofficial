    ...
    <div class="modal">
      <div class="content">
        ...
        <section id="step-1" ?active="${this._currentStep === 1}">
          ...
          <div>
            <h4>${this.localize(t`wizard.step2.disclaimer.introduction.title`)}</h4>
            <p>
              ${unsafeHTML(this.localize(t`wizard.step2.disclaimer.introduction.text`))}
            </p>
            <h4>${this.localize(t`wizard.step2.disclaimer.software.title`)}</h4>
            <p>${unsafeHTML(this.localize(t`wizard.step2.disclaimer.software.text`))}</p>
            <h4>${this.localize(t`wizard.step2.disclaimer.assets.title`)}</h4>
            <p>${unsafeHTML(this.localize(t`wizard.step2.disclaimer.assets.text`))}</p>
            <h4>${this.localize(t`wizard.step2.disclaimer.agreement.title`)}</h4>
            <p>
              ${unsafeHTML(this.localize(t`wizard.step2.disclaimer.agreement.text`))}
            </p>
          </div>
        </section>
