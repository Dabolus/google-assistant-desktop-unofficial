      ...
      disclaimer: {
        ...
        software: {
          ...
          text:
            ...
            'by Google itself. The authors do their best to provide the most straightforward and ' +
            'easiest possible interaction with the Google Assistant APIs to the end users, but ' +
            'as humans they can make errors. Expect to find some bugs in the product, especially ' +
            'in its initial phase of development. Also, to give full transparency to the end ' +
            'users, the authors decided to make the software open source. This means that the ' +
            'end users are free to browse the source code of the software and to eventually ' +
            'compile the source code and contribute to the development of the software itself. ' +
            'The source code of the software is available <a href="https://github.com/Dabolus/google-assistant-desktop-unofficial" target="source-code">at this link</a>.',
        },
        assets: {
          title: 'The assets',
          text:
